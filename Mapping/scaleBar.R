## Add scale bar and north arrow to ggplot2 map
## Source: http://editerna.free.fr/wp/?p=76
...
## Another version
## Source: http://stackoverflow.com/questions/15486551/scale-bar-and-north-arrow-on-map-ggplot2?lq=1
