...
## Add header and enclosing brackets
## N.B.: below uses *NIX system commands 'sed' and 'echo'

## append file format
lay.raw <- paste0(law.raw,".TXT")
## add to top: "infix dictionary using NAME_OF_DATA_FILE.TXT {"
system( paste("sed -i '1i infix dictionary using", lay.raw, "{", sep = " ") )
## add to bottom: "}"
system( paste("echo '}' >>", lay.raw, sep=" ") )
